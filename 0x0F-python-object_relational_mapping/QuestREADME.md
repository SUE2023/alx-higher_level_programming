INSTRUCTIONS TO THE  0x0F. Python - Object-relational mapping PROJECT
Before you start…
Please make sure your MySQL server is in 8.0 -> How to install MySQL 8.0 in Ubuntu 20.04( project MYSQL)
...
6. First state model
picture: YOU CAN IGNORE SQL AND TRUST ORM MAGIC
